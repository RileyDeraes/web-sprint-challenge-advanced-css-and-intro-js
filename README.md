...
2. Talk about 3 different things you can do to ensure your website is accessible. 
    ...
    - Using high-contrast colors,or providing a high-contrast theme, to those who are visually impaired but not blind.
3. How would you explain the concept of a variable to someone new to programming?
    - A variable ("var") is a container that can store information in Javascript. It can hold practically any sort of data, but every variable MUST have a unique name. (Although you can re-assign them.)
4. What is the purpose of using functions in code?
    - A function allows you to repeat a specific set of instructions without having to use the whole slew of code. "Keep it DRY!"
...
* [x] Student demonstrates and can explain a deep understanding of basic programming concepts, when walking Team Lead through the explaination of their code.
    - I like to leave comments/notes on my code explaining what's happening.
* [x] Use advanced array methods (.map, .reduce, .filer) to refactor your MVP code (create an array of all artists born in the 1900s with .filter, for example) - do this seperate from your MVP tasks
    - It was easier to use some of these in some cases.
